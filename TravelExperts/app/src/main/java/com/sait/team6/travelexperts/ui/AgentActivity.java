 ...
 */
public class AgentActivity extends Activity implements AdapterView.OnItemClickListener {
    ...
    private Agent loadData(){
        Agent agentsList1 = new Agent();
        agentDB = new AgentDB(AgentActivity.this);
    ...
    class ReadFeed extends AsyncTask<Void, Void, Void> {
        ...
        @Override
        protected void onPostExecute(Void result) {
            AgentActivity.this.updateDisplay();
        }
    }
